  ...
  def default_meta_tags
    {
      ...
      reverse: true,
      charset: 'utf-8',
      description: '釣れた結果を知るのではなく、釣れる環境をみんなで共有するwebサイトバスフィッシングは、非常にゲーム性の高いジャンルで、情報が釣果を左右します。場所の環境を知るためにはその場所に行くしかありませんでした。このような問題を解決するために、詳細な環境を投稿でき、共有るようなアプリを制作しました。',
      ...
      og: {
        ...
        description: '釣れた結果を知るのではなく、釣れる環境をみんなで共有するwebサイトバスフィッシングは、非常にゲーム性の高いジャンルで、情報が釣果を左右します。場所の環境を知るためにはその場所に行くしかありませんでした。このような問題を解決するために、詳細な環境を投稿でき、共有るようなアプリを制作しました。', # もしくは description: :description
        type: 'website',
        url: request.original_url,
        image: image_url('aicon2.png'),
        locale: 'ja_JP',
      },
      twitter: {
        card: 'summary',
