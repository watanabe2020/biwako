  ...
  def default_meta_tags
    {
      ...
      keywords: '滋賀県,琵琶湖,釣り,バスフィッシング,釣りポイント,ルアー,ルアー釣り,釣り場,案内,釣果情報,通販,釣,釣り具,フィッシング,fishing,レジャー,アウトドア,遊び,趣味,釣果,釣果情報,釣場,ポイント,キャンプ,水遊び,自由研究,初心,中級,上級,シマノ,ダイワ,浜大津,堅田,唐崎,瀬田川,木浜,琵琶湖大橋,矢橋帰帆島,近江舞子,沖島,奥琵琶湖,彦根,長浜,北湖,南湖,',
